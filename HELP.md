...
* The following dependencies are not known to work with Spring Native: 'Spring Configuration Processor, Liquibase
  Migration, Spring Boot DevTools'. As a result, your application may not work as expected.
...
```
$ docker run --rm -p 8080:8080 db:0.0.1-SNAPSHOT
```
